...
enum spi_command {
		...
		// register commands
		RREG = 0x20,					// samo prvi bajt -> broj registara koji moraju biti procitani-1(inicijalno nula)
		WREG = 0x40						// samo prvi bajt -> broj registara u koje mora biti upisano-1 (inicijalno nula)
	} ;
 ...
 enum ID_bits {
	...
	enum CONFIG1_bits {
		...
		DR0 = 0x01,
							...
							// ADS1299
		CONFIG1_const = 0x96,    // tako pise u Datasheetu - kod Adama => CONFIG1_const = 0xE0
	...
	enum CONFIG2_bits {
		...
		INT_TEST_1HZ = INT_CAL, 
		INT_TEST_2HZ = (INT_CAL | CAL_FREQ0),
